...
<div className='flex-1 p-2 md:p-4 border-2 text-black'>
  <div className="w-full box-shadow-xl rounded-xl p-4 bg-[url('/public/monthly.jpg')] bg-cover">
          ...
          <div className="flex md:flex-col sm:flex-row p-4 gap-4  border-b-2 border-gray-500 shadow-lg">
            <form className="w-full" onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col sm:flex-row  gap-4 justify-center items-center">
                         ...
                         value={weekly}
                         maxLength={200}
                         className="p-4 w-full flex-1  border-2  border-gray-600 rounded-lg"
                         placeholder='Add_Monthly_Task'
                         onChange={weeklyTask}
                         />

                          <button type="submit" className="border p-2 border-gray-400 rounded-sm w-20 h-10 ">ADD</button>
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-8">
              ...
              <div className=" w-full lg:w-72 flex-shrink-0 flex flex-col gap-4">    
                  ...
                  <div className=" flex flex-row lg:flex-col gap-3">
                     <button 
                        className=" flex-1 lg:w-full border border-gray-600 rounded-lg p-2 text-black font-black cursor-pointer hover:bg-white"
                        onClick={()=>edits(index)} ><i className="bi bi-pencil"></i>Modify</button>

             
                     <button
                         className=" flex-1 lg:w-full border border-gray-600 rounded-lg p-2 text-white font-black cursor-pointer hover:bg-black"
